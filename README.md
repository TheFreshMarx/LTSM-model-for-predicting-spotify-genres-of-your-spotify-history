...
3. Ensure you have the necessary R packages installed (e.g., `keras`, `tensorflow`, `dplyr`, etc.).
4. Run the data preprocessing scripts first to see the LLM classification process, followed by the main model training script.
